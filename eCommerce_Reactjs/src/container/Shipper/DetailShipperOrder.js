                ...
                <div className="card-body">
                    {DataOrder && DataOrder.addressUser && (
                        <div className="mb-3">
                            ...
                            <p>
                                <strong>Email:</strong>{" "}
                                {DataOrder.addressUser.shipEmail}
                            </p>
                            <p>
            ...
            <div className="card mb-4">
                <div className="card-body">
                    <div className="d-flex gap-2">
                        {((DataOrder.statusOrderData?.code === "S3" || DataOrder.statusOrderData?.code === "S4") && !DataOrder.shipperId) && (
                            <button
                        ...
                        {DataOrder.statusOrderData?.code === "S4" && DataOrder.shipperId === user?.id && (
                            <button
                        ...
                        {DataOrder.statusOrderData?.code === "S5" && DataOrder.shipperId === user?.id && (
                            <button
